...
- Extract authentication/identity from transport (`SharedMacroAuthorizationExtractor`, `OptionalSharedMacroAuthorizationExtractor`, JWT, signed internal header, request context).
