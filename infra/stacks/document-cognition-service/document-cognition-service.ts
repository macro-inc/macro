...
export class DocumentCognitionService extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    super('my:components:DocumentCognitionService', name, {}, opts);
    this.tags = tags;
        ...
        targetTrackingScalingPolicyConfiguration: {
          ...
          customizedMetricSpecification: {
            ...
            dimensions: [
              {
                name: 'ClusterName',
                value: pulumi.interpolate`${this.cloudStorageClusterName}`,
              },
              {
                name: 'ServiceName',
                value: pulumi.interpolate`${this.service.service.name}`,
              },
            ],
            statistic: 'Maximum',
            unit: 'Percent',
