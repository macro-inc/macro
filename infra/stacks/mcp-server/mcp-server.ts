...
export class McpServer extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    super('my:components:McpServer', name, {}, opts);
    this.tags = tags;
            ...
            service: {
              ...
              logConfiguration: {
                ...
                options: {
                  ...
                  dd_source: 'fargate',
                  dd_tags: `project:mcp-server, env:${stack}`,
                  provider: 'ecs',
                },
              },
              portMappings: [
