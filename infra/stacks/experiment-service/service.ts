...
const BASE_NAME = 'experiment-service';
const BASE_PATH = '../../../rust/cloud-storage';
export const SERVICE_DOMAIN_NAME = `experiments-service${
  stack === 'prod' ? '' : `-${stack}`
}.${BASE_DOMAIN}`;

type CreatExperimentServiceArgs = {
  vpc: {
...
export class ExperimentService extends pulumi.ComponentResource {
            ...
            service: {
              ...
              logConfiguration: {
                ...
                options: {
                  ...
                  dd_service: `experiment-service-${stack}`,
                  dd_source: 'fargate',
