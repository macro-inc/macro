...
export class OrganizationService extends pulumi.ComponentResource {
  ...
  constructor(
          ...
          Statement: [
            {
              ...
              Resource: [
                `arn:aws:ses:${awsRegion}:569036502058:identity/macro.com`,
              ],
              Effect: 'Allow',
            },
          ],
    ...
    this.role = new aws.iam.Role(
      `${BASE_NAME}-role`,
      {
        ...
        tags: this.tags,
        managedPolicyArns: [sesPolicy.arn, secretsManagerPolicy.arn],
      },
      { parent: this }
    );
            ...
            service: {
              ...
              logConfiguration: {
                ...
                options: {
                  ...
                  dd_service: `organization-service-${stack}`,
                  dd_source: 'fargate',
