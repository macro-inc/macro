...
The cache image is no longer rebuilt by CI; local development uses `docker/Dockerfile.dev` via `just run_local`, and service deployments use prebuilt binaries.
