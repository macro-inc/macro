        ...
        taskDefinitionArgs: {
          ...
          containers: {
            ...
            service: {
              ...
              memory: 512,
              environment: [
                { name: `STATIC_FILE_SERVICE_DYNAMODB_TABLE_NAME`, value: args.dynamoDbTableName },
                { name: `STATIC_FILE_SERVICE_S3_BUCKET_URL`, value: STORAGE_LOCATION },
                { name: 'STATIC_FILE_SERVICE_S3_EVENT_QUEUE_URL', value: queueQueue.url },
