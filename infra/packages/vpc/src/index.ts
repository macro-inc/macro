...
export function get_coparse_api_vpc() {
  return {
    ...
    publicSubnetIds: [
      ...
      'subnet-042a406ca5480af5d', // public-subnet3 - us-east-1c
      'subnet-09bb402ca097d0aa9', // public-subnet4 - us-east-1b
      'subnet-0b7efc5a66eef73e3', // public-subnet5 - us-east-1a
    ],
  };
}
