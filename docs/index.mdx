...
description: "Extremely fast, unified interface for all your work. @linked together in one database."
---
...
With a Rust microservices backend and optimized Solid frontend, Macro is designed for performance. Instant search, real-time collaboration, and keyboard-driven workflows keep you moving fast.
