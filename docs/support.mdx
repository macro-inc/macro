...
<AccordionGroup>
  ...
  <Accordion title="I @mentioned someone in a doc and they weren't notified">
    That's by design: mentions in a document's  don't notify or share. Mention them in a , or share the doc with them explicitly. The reasoning is covered in [Mentions](/concepts/mentions#what-happens-when-you-mention).
  </Accordion>
