...
it to its compact state and dismissing the keyboard. The plus opens image
attachments. While the main document editor is focused with the virtual keyboard
