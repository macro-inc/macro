...
Capabilities are loaded live and independently for In-memory, connected Cursor, and every
...
the same live capability discovery and retains its existing save action.
