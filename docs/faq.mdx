...
<AccordionGroup>
  ...
  <Accordion title="Does Macro have its own email or integrate with my email?">
    Macro is not an email server, it's just an email client. We integrate with your existing Google Workspace or Gmail account. Outlook and custom IMAP/SMTP email has been a popular request and we plan on adding that soon.
  </Accordion>

  <Accordion title="Can I self-host Macro?">
    Yes you can according to our AGPL license, but as of June 2026, this hasn't been our primary focus.
  ...
  <Accordion title="Is Macro fully open source? What is the license?">
    **Macro is fully open source.** Not "open core". We were previously source-available under the BSL but on [May 31 2026](https://x.com/j_becke/status/2061153001536975206) we moved to a fully open-source model under the AGPLv3. The AGPL is a copyleft license meaning derivative works also need to be open source. That means that if you build on top of Macro, you need to keep your code open source under the AGPLv3. If you want to build on top of Macro and not use the AGPLv3 — i.e. close-source or an incompatible license — you need to obtain a different license from us. Contact [licensing@macro.com](mailto:licensing@macro.com) to discuss with us.
  </Accordion>
