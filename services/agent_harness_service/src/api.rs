...
use agent_session::domain::ports::{AgentSessionNotificationRecipient, StandaloneSessionOpener};
...
fn api_router<T, R, O, Access, Auth>(
    read_state: AgentSessionRouterState<T, Access, Auth>,
    control_state: AgentSessionControlState<R, Access, Auth>,
    create_state: AgentSessionCreateState<O, Auth>,
) -> Router
