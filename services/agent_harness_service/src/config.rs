...
pub struct Config {
    ...
    /// Base url of the Cursor API. Configurable only so a test deployment can
    /// point at a stand-in; there is one real value.
    #[macro_config_default(String::from("https://api.cursor.com"))]
