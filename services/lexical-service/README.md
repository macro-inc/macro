...
utilities from the shared `packages/lexical-core` workspace package. In general the pattern should be to define the
utilities in lexical-core and then bind them to endpoints here.
