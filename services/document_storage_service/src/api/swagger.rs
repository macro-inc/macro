...
#[openapi(
    ...
    paths(
        ...
        // initiatives
        initiative::inbound::axum_router::list_initiatives_handler,
        initiative::inbound::axum_router::create_initiative_handler,
        initiative::inbound::axum_router::get_initiative_handler,
        initiative::inbound::axum_router::update_initiative_handler,
        initiative::inbound::axum_router::delete_initiative_handler,
        initiative::inbound::axum_router::assign_initiative_tasks_handler,
        initiative::inbound::axum_router::unassign_initiative_task_handler,
        // collab surfaces
