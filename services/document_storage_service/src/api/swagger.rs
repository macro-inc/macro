...
#[openapi(
    ...
    components(
        schemas(
            ...
            agent_session::wire::SessionBotDto,
            agent_session::wire::FoldedMessageDto,
            agent_session::wire::FoldedAuthorDto,
            agent_session::wire::FoldedMessagePartDto,
            agent_session::wire::ToolStatusDto,
            agent_session::wire::ToolDetailDto,
            agent_session::wire::FileDiffDto,
            agent_session::wire::PermissionOptionDto,
            agent_session::wire::PermissionOptionKindDto,
            agent_session::wire::PermissionOutcomeDto,
            agent_session::wire::StopReasonDto,
