...
use channels::inbound::axum_router::{
    ...
    ApiChannelDetail, ApiChannelParticipant, ApiCountedReaction, ApiMessageAttachment,
    ApiParticipantRole, CreateEntityMentionRequest, CreateEntityMentionResponse,
    DeleteEntityMentionResponse, GetAttachmentReferencesResponse, PostActivityRequest,
};
...
#[openapi(
    ...
    components(
        schemas(
            ...
            // Channels
            channels::inbound::axum_router::ApiMessageSender,
            ApiCountedReaction,
