...
#[tracing::instrument(skip(state, user_context, document_context, _access), fields(user_id=?user_context.user_context.user_id, file_type=?document_context.file_type))]
