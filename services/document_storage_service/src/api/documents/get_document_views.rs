...
#[tracing::instrument(skip(db, user_context, document_id, _access), fields(user_id=?user_context.user_context.user_id, document_id=?document_context.document_id, original_document_id=?document_id))]
