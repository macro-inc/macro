...
use crate::cursor::MAX_SSE_PAYLOAD;
...
/// [`MAX_SSE_PAYLOAD`](crate::cursor::MAX_SSE_PAYLOAD). Fixtures are
...
///
/// Mirrors what [`crate::cursor::CursorClient`]'s stream does per record: a
