...
use agent_client_protocol::schema::v1::{
    ...
    Implementation, InitializeRequest, InitializeResponse, McpCapabilities,
    McpServer as AcpMcpServer, NewSessionRequest, NewSessionResponse, Notification,
    PromptCapabilities, PromptRequest, PromptResponse, RequestId, Response, SessionId,
