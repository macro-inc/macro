...
pub enum SetChannelLabelOutcome {
    ...
    LabelNotFound,
    /// Direct messages cannot be labelled.
    ChannelNotLabelable,
...
/// Direct messages cannot be grouped; all other channel types are eligible.
pub fn can_label_channel(is_direct_message: bool) -> bool {
    !is_direct_message
}
