    ...
    service
        .handle(ChannelEvent::MessagePosted {
            ...
            message: MutatedMessage {
                ...
                sender_id: Sender::new_from_user(sender),
                triggered_by: None,
                content: Some("@macro help".to_string()),
                created_at: now,
                updated_at: now,
                edited_at: None,
                deleted_at: None,
    ...
    service
        .handle(ChannelEvent::MessagePosted {
            ...
            message: MutatedMessage {
                ...
                triggered_by: None,
                content: Some("@bot help".to_string()),
                created_at: now,
                updated_at: now,
                edited_at: None,
                deleted_at: None,
...
fn channel_message(channel_id: Uuid, message_id: Uuid) -> MutatedMessage {
    ...
    MutatedMessage {
        ...
        triggered_by: None,
        content: Some("updated message".to_string()),
        created_at: now,
        updated_at: now,
        edited_at: Some(now),
        deleted_at: None,
...
fn message_posted_with_mentions(
    ...
    ChannelEvent::MessagePosted {
        ...
        message: MutatedMessage {
            ...
            sender_id: sender,
            triggered_by: None,
            content: Some("hello bots".to_string()),
            created_at: now,
            updated_at: now,
            edited_at: None,
            deleted_at: None,
...
fn broker_events_skip_mentions_on_message_changed() {
    ...
    let events = broker_events_for_event(&ChannelEvent::MessageChanged {
        ...
        message: MutatedMessage {
            ...
            sender_id: Sender::new_from_user(user("alice@example.com")),
            triggered_by: None,
            content: Some("edited to mention a bot".to_string()),
            created_at: now,
            updated_at: now,
            edited_at: Some(now),
            deleted_at: None,
...
fn mention_broker_events_map_message_posted_mentions() {
    ...
    let events = mention_broker_events_for_event(&ChannelEvent::MessagePosted {
        ...
        message: MutatedMessage {
            ...
            sender_id: Sender::new_from_user(user("alice@example.com")),
            triggered_by: None,
            content: Some("@bot @doc-1".to_string()),
            created_at: now,
            updated_at: now,
            edited_at: None,
            deleted_at: None,
