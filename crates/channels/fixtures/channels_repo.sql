...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
-- msg1: oldest, has thread
('00000000-0000-0000-0000-000000000001', 'channel', '00000000-0000-0000-0000-000000000c01', NULL,
...
('00000000-0000-0000-0000-000000000002', 'channel', '00000000-0000-0000-0000-000000000c01', NULL,
   'macro|user-b@test.com', 'deleted with reply', '2024-01-01 11:00:00+00', '2024-01-01 11:00:00+00', NULL, '2024-01-02 00:00:00');
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
-- msg3: newest, edited
('00000000-0000-0000-0000-000000000003', 'channel', '00000000-0000-0000-0000-000000000c01', NULL,
   'macro|user-a@test.com', 'third message edited', '2024-01-01 12:00:00+00', '2024-01-01 13:00:00+00', '2024-01-01 13:00:00', NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
-- deleted_msg: soft-deleted with NO active replies → should NOT appear
('00000000-0000-0000-0000-000000000004', 'channel', '00000000-0000-0000-0000-000000000c01', NULL,
...
('00000000-0000-0000-0000-000000000005', 'channel', '00000000-0000-0000-0000-000000000c02', NULL,
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b001', 'channel', '00000000-0000-0000-0000-000000000c01',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b002', 'channel', '00000000-0000-0000-0000-000000000c01',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b003', 'channel', '00000000-0000-0000-0000-000000000c01',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b004', 'channel', '00000000-0000-0000-0000-000000000c01',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b005', 'channel', '00000000-0000-0000-0000-000000000c01',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b006', 'channel', '00000000-0000-0000-0000-000000000c01',
...
-- attachments on msg1
INSERT INTO comms_attachments (id, message_id, entity_type, entity_id, width, height, created_at) VALUES
('00000000-0000-0000-0000-00000000a001', '00000000-0000-0000-0000-000000000001', 'document', 'doc-1', NULL, NULL, '2024-01-01 10:00:00+00');
INSERT INTO comms_attachments (id, message_id, entity_type, entity_id, width, height, created_at) VALUES
('00000000-0000-0000-0000-00000000a002', '00000000-0000-0000-0000-000000000001', 'image', 'img-1', 800, 600, '2024-01-01 10:00:01+00');

-- attachment on msg3
INSERT INTO comms_attachments (id, message_id, entity_type, entity_id, width, height, created_at) VALUES
('00000000-0000-0000-0000-00000000a003', '00000000-0000-0000-0000-000000000003', 'document', 'doc-2', NULL, NULL, '2024-01-01 12:00:00+00');

-- attachment on deleted msg2: should be excluded from channel-level attachments
INSERT INTO comms_attachments (id, message_id, entity_type, entity_id, width, height, created_at) VALUES
('00000000-0000-0000-0000-00000000a004', '00000000-0000-0000-0000-000000000002', 'image', 'img-deleted', 640, 480, '2024-01-01 11:00:30+00');
...
('00000000-0000-0000-0000-000000000031', 'channel', '00000000-0000-0000-0000-000000000c03', NULL,
...
('00000000-0000-0000-0000-00000000b031', 'channel', '00000000-0000-0000-0000-000000000c03',
...
('00000000-0000-0000-0000-000000000041', 'channel', '00000000-0000-0000-0000-000000000c04', NULL,
   'macro|user-b@test.com', 'participant thread parent', '2024-01-02 10:00:00+00', '2024-01-02 10:00:00+00', NULL, NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b041', 'channel', '00000000-0000-0000-0000-000000000c04',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b042', 'channel', '00000000-0000-0000-0000-000000000c04',
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b043', 'channel', '00000000-0000-0000-0000-000000000c04',
...
('00000000-0000-0000-0000-000000000042', 'channel', '00000000-0000-0000-0000-000000000c04', NULL,
...
('00000000-0000-0000-0000-000000000043', 'channel', '00000000-0000-0000-0000-000000000c04', NULL,
...
('00000000-0000-0000-0000-000000000044', 'channel', '00000000-0000-0000-0000-000000000c04', NULL,
   'macro|user-b@test.com', 'plain parent', '2024-01-02 13:00:00+00', '2024-01-02 13:00:00+00', NULL, NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, thread_id, sender_id, content, created_at, updated_at, edited_at, deleted_at) VALUES
('00000000-0000-0000-0000-00000000b044', 'channel', '00000000-0000-0000-0000-000000000c04',
