...
- Assignees (00000001-0000-0000-0000-000000000001): entity type, multi-select. Use entity_refs with entity_type='user' and entity_id='macro|email@domain.com' for a person, or entity_id='bot|<uuid>' to assign an agent, which starts it on the task.
