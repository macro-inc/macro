...
VALUES (1, '{"pages":[{"highlights":[{"comments":[{"id":12,"text":"PDF original"},{"id":"999","text":"Stale"},{"id":"external-pdf-id","text":"External"}]}]}]}');
...
INSERT INTO notification(id, notification_event_type, event_item_id, event_item_type, service_sender, metadata)
VALUES (gen_random_uuid(), 'commented_on_document', 'legacy-md', 'document', 'dss',
    '{"commentId":424242,"threadId":1,"commentText":"Removed long ago"}'::jsonb);
