...
VALUES ('11111111-1111-1111-1111-111111111111', 'Test Public Channel', 'public', NULL, 'owner1'),
       ('22222222-2222-2222-2222-222222222222', 'Test Organization Channel', 'private', NULL, 'owner2'),
...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, thread_id)
VALUES ('11111111-1111-1111-1111-111111111111', 'channel', '11111111-1111-1111-1111-111111111111', 'user1', 'Test message 1',
        NULL);

INSERT INTO comms_entity_mentions (id, source_entity_type, source_entity_id, entity_type, entity_id)
VALUES ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'message', '11111111-1111-1111-1111-111111111111', 'user', 'user1');
