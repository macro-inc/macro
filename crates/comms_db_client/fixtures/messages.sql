...
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('gggggggg-gggg-gggg-gggg-gggggggggggg', 'channel', '66666666-6666-6666-6666-666666666666', 'user5',
     'Your private document for review', '2024-01-07T15:30:00Z', NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'channel', '33333333-3333-3333-3333-333333333333', 'user3',
     'Starting a thread about this doc', '2024-01-08T08:00:00Z', NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('iiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii', 'channel', '33333333-3333-3333-3333-333333333333', 'user4',
     'Here are my thoughts on the doc', '2024-01-08T08:30:00Z', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh');
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('jjjjjjjj-jjjj-jjjj-jjjj-jjjjjjjjjjjj', 'channel', '33333333-3333-3333-3333-333333333333', 'user5',
...
('kkkkkkkk-kkkk-kkkk-kkkk-kkkkkkkkkkkk', 'channel', '11111111-1111-1111-1111-111111111111', 'user6',
     'This is from a user who left the channel', '2024-01-09T09:00:00Z', NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
-- Deleted message (should not be returned in references)
('llllllll-llll-llll-llll-llllllllllll', 'channel', '33333333-3333-3333-3333-333333333333', 'user1',
     'This message was deleted but had attachments', '2024-01-10T10:00:00Z', NULL, '2024-01-10T11:00:00Z');
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
-- For special attachment cases
('delmsg-del1-0000-0000-000000000001', 'channel', '33333333-3333-3333-3333-333333333333', 'user2', 'This is a deleted message',
     '2024-06-12T12:00:00Z', NULL, '2024-06-12T13:00:00Z');
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('threadmsg-0001-0000-0000-0000000001', 'channel', '33333333-3333-3333-3333-333333333333', 'user3', 'This is a thread reply',
     '2024-06-12T14:00:00Z', 'hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', NULL);
INSERT INTO comms_messages (id, parent_entity_type, parent_entity_id, sender_id, content, created_at, thread_id, deleted_at) VALUES
('leftusermsg-0001-0000-000000000001', 'channel', '33333333-3333-3333-3333-333333333333', 'user7',
