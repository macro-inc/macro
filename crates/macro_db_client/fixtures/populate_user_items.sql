...
(SELECT 'macro|user5@user.com', 'user5@user.com','stripe_id5', 1, 'a5555555-5555-5555-5555-555555555555');
...
INSERT INTO public."SharePermission" ("id", "isPublic", "publicAccessLevel", "linkShare", "linkShareAccessLevel", "createdAt", "updatedAt")
(SELECT 'sp-document1', true, 'view', 'PUBLIC', 'view', '2019-10-16 00:00:00', '2019-10-16 00:00:00');
...
INSERT INTO public."SharePermission" ("id", "isPublic", "publicAccessLevel", "linkShare", "linkShareAccessLevel", "createdAt", "updatedAt")
(SELECT 'sp-document2', false, NULL, NULL, NULL, '2019-10-16 00:00:00', '2019-10-16 00:00:00');
INSERT INTO public."DocumentPermission" ("documentId", "sharePermissionId")
