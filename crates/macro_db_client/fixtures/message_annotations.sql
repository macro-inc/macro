...
INSERT INTO "PdfPlaceableCommentAnchor"(uuid, "documentId", owner, root_id, page, "originalPage", "originalIndex", "shouldLockOnSave", "xPct", "yPct", "widthPct", "heightPct", rotation, "wasEdited", "wasDeleted", "allowableEdits")
...
FROM "PdfPlaceableCommentAnchor" a WHERE t.root_id = a.root_id;
UPDATE comms_message_threads SET resolved = true WHERE root_id = '00000000-0000-0000-0000-000000000002';
INSERT INTO "PdfHighlightAnchor"(uuid, "documentId", owner, root_id, page, red, green, blue, alpha, type, text, "pageViewportWidth", "pageViewportHeight")
