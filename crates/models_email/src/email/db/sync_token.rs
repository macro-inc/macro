...
impl From<crate::email::service::sync_token::SyncTokens> for SyncTokens {
    fn from(service_sync_tokens: crate::email::service::sync_token::SyncTokens) -> Self {
        Self {
            link_id: service_sync_tokens.link_id,
            contacts_sync_token: service_sync_tokens.contacts_sync_token,
            other_contacts_sync_token: service_sync_tokens.other_contacts_sync_token,
        }
    }
}
