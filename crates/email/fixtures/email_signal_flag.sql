...
-- Thread e207 (is_signal=true, stale on purpose; inbox_visible=false, stale
--   too): only a SPAM message from plain@example.com — spam is shown in the
--   inbox as noise, so update_thread_metadata must make it visible and clear
--   the flag.
...
VALUES ('00000000-0000-0000-0000-0000000be001', '00000000-0000-0000-0000-000000000e01', 'CATEGORY_PROMOTIONS', 'CATEGORY_PROMOTIONS', NOW()),
       ...
       ('00000000-0000-0000-0000-0000000be003', '00000000-0000-0000-0000-000000000e01', 'SPAM', 'SPAM', NOW());
...
VALUES ('00000000-0000-0000-0000-00000000e201', '00000000-0000-0000-0000-000000000e01', true, false, true, NOW(), NOW()),
       ...
       ('00000000-0000-0000-0000-00000000e207', '00000000-0000-0000-0000-000000000e01', false, false, true, NOW(), NOW());
...
VALUES ('00000000-0000-0000-0000-00000000e501', '00000000-0000-0000-0000-00000000e201', '00000000-0000-0000-0000-000000000e01',
       ...
       ('00000000-0000-0000-0000-00000000e509', '00000000-0000-0000-0000-00000000e207', '00000000-0000-0000-0000-000000000e01',
        'provider-msg-e509', 'gid-e509', FALSE, '00000000-0000-0000-0000-0000000ce001', '2025-01-05 18:00:00 +00:00',
        false, false, false, false, NOW(), NOW());
...
VALUES ('00000000-0000-0000-0000-00000000e502', '00000000-0000-0000-0000-0000000be001'),
       ...
       ('00000000-0000-0000-0000-00000000e509', '00000000-0000-0000-0000-0000000be003');
