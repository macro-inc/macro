...
fn channel_thread_message(
    ...
    ChannelMessage {
        ...
        bot_profile: None,
        content: Some("thread parent".to_string()),
        created_at: DateTime::default(),
        updated_at,
        edited_at: None,
        deleted_at: None,
        ...
        thread: ThreadInfo {
            ...
            preview: vec![ThreadReply {
                ...
                bot_profile: None,
                content: Some("thread reply".to_string()),
...
async fn touched_soup_orders_by_touch_and_drops_unhydrated() {
    ...
    soup_mock
        ...
        .returning(move |req| {
            ...
            assert!(!req.include_projects, "expanded soup excludes projects");
            Box::pin(async move {
                Ok(vec![
                    TouchedEntity {
    ...
    // Three candidates against a limit of 20: the feed is exhausted.
