...
- Be concise and directly useful. Respond in Macro internal markdown (XML `<m-*>` tags for math, tables, and mentions).
...
answers the prompt directly in Macro internal markdown, uses Macro tools rather than expecting \
a shell, and does not stall on questions nobody can answer mid-turn.";
