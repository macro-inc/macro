...
VALUES
    ...
    ('a2222222-2222-2222-2222-222222222222', 'user2@user.com', 'user2@user.com', 'stripe_placeholder'),
    ('a3333333-3333-3333-3333-333333333333', 'user3@user.com', 'user3@user.com', 'stripe_placeholder'),
    ('a4444444-4444-4444-4444-444444444444', 'user4@user.com', 'user4@user.com', 'stripe_placeholder');
