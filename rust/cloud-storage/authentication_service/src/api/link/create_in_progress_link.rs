...
#[tracing::instrument(skip(ctx, ip_context, user_context), fields(client_ip=?ip_context, user_id=%user_context.user_id, fusion_user_id=%user_context.fusion_user_id))]
