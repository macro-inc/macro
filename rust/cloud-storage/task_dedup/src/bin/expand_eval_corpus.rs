...
//!   --per-scenario 8 --out rust/cloud-storage/task_dedup/fixtures/eval/synthetic_generated.json
//! cargo run -p task_dedup --features backfill --bin expand_eval_corpus -- mine \
//!   --prod rust/cloud-storage/task_dedup/fixtures/eval/prod_title_only.json \
//!   --prod rust/cloud-storage/task_dedup/fixtures/eval/prod_with_body.json \
//!   --out  rust/cloud-storage/task_dedup/fixtures/eval/prod_mined_pairs.json
//! ```
