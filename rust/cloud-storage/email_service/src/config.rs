...
pub struct Config {
    ...
    #[serde(rename = "AUTHENTICATION_SERVICE_SECRET_KEY")]
    pub auth_service_secret_key: String,

    /// URL for auth service
    #[serde(rename = "AUTHENTICATION_SERVICE_URL")]
...
impl Config {
    pub fn from_env() -> anyhow::Result<Self> {
        macro_config::ConfigLoader::load::<Config>().context("failed to load email service config")
    }
}
