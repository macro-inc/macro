...
use crate::domain::ports::AggregateFrecencyStorage;
...
mock! {
    ...
    impl AggregateFrecencyStorage for FrecencyStorage {
        ...
        fn get_top_entities<'b>(&self, user_id: MacroUserIdStr<'b>, limit: u32) -> impl Future<Output = Result<Vec<crate::domain::models::AggregateFrecency>, Infallible>> + Send;
