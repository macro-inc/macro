...
// these are computer virust
// we're estimating tokens of attachments for some reason but the estimates are not used
// todo: remove estimates
pub const DEFAULT_CHANNEL_TOKENS: i64 = 5000;
pub const DEFAULT_EMAIL_TOKENS: i64 = 3000;
pub const DEFAULT_PROJECT_TOKENS: i64 = 1000;
