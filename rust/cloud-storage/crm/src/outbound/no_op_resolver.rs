...
//! read existing CRM rows. Wiring in a real unfurl-backed resolver in
//! those binaries would force them to carry the reqwest + scraper
//! deps for code paths they never hit.
//!
