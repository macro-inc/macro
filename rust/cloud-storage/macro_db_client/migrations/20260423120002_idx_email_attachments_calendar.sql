...
-- for EmailLiteral::CalendarOnly(true): filename ILIKE '%.ics' OR mime_type = 'application/ics'.
...
--
-- This index was created ahead of migration via:
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_email_attachments_calendar_message_id
    ...
    WHERE filename ILIKE '%.ics' OR mime_type = 'application/ics';
