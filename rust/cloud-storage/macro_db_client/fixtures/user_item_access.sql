...
INSERT INTO public."macro_user" ("id", "username", "email", "stripe_customer_id")
VALUES ('a6666666-6666-6666-6666-666666666666', 'test-user@test.com', 'test-user@test.com', 'stripe_placeholder'),
       ('a7777777-7777-7777-7777-777777777777', 'user0@test.com', 'user0@test.com', 'stripe_placeholder'),
       ('a8888888-8888-8888-8888-888888888888', 'user1@test.com', 'user1@test.com', 'stripe_placeholder'),
       ('a9999999-9999-9999-9999-999999999999', 'user2@test.com', 'user2@test.com', 'stripe_placeholder'),
       ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'user3@test.com', 'user3@test.com', 'stripe_placeholder'),
       ('abbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'user4@test.com', 'user4@test.com', 'stripe_placeholder'),
       ('accccccc-cccc-cccc-cccc-cccccccccccc', 'user5@test.com', 'user5@test.com', 'stripe_placeholder')
