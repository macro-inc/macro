...
VALUES (gen_random_uuid(), 'macro|user@user.com', '11111111-1111-1111-1111-111111111111', 'document', 'owner'),
       (gen_random_uuid(), 'macro|user@user.com', '22222222-2222-2222-2222-222222222222', 'document', 'owner'),
       (gen_random_uuid(), 'macro|user@user.com', '33333333-3333-3333-3333-333333333333', 'document', 'owner'),
