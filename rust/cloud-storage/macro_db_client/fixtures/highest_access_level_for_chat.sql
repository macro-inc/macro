...
TRUNCATE TABLE public."User", public."Project", public."Chat", public."SharePermission", public."ChatPermission", public."ProjectPermission", public."UserItemAccess" RESTART IDENTITY CASCADE;
...
VALUES ('a1111111-1111-1111-1111-111111111111', 'user1@test.com', 'user1@test.com', 'stripe_placeholder'),
       ...
       ('a4444444-4444-4444-4444-444444444444', 'user4@test.com', 'user4@test.com', 'stripe_placeholder');
...
VALUES ('d-child', 'Nested Chat', 'user-1', 'p-parent'),
       ('d-standalone', 'Standalone Chat', 'user-2', NULL),
       ('d-private', 'Private Chat', 'user-1', NULL);
...
('10000000-0000-0000-0000-000000000001', 'user-1', 'd-child', 'chat', 'view'),
...
('10000000-0000-0000-0000-000000000004', 'user-1', 'd-standalone', 'chat', 'comment'),

-- user-2 has explicit 'view' on d-child, to test that the query correctly filters by user.
('10000000-0000-0000-0000-000000000005', 'user-2', 'd-child', 'chat', 'view'),


('10000000-0000-0000-0000-000000000006', 'user-3', 'd-standalone', 'chat', 'edit');