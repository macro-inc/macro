...
use properties::{PermissionCheckerImpl, PropertiesPgRepo, PropertiesServiceImpl};
use soup::{
...
type PropertiesService = PropertiesServiceImpl<PropertiesPgRepo, PermissionCheckerImpl>;
