use crate::{
    ...
    config::{DocumentStorageServiceCloudfrontSignerPrivateKeySecretName, DocumentPermissionJwtSecretKey},
    service::s3::S3,
};
use anyhow::Context;
use comms::{
...
async fn main() -> anyhow::Result<()> {
    ...
    let cloudfront_signer_private_key = secretsmanager_client
        .get_maybe_secret_value(env, DocumentStorageServiceCloudfrontSignerPrivateKeySecretName::new()?)
        .await?;
