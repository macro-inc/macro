            ...
            match hit.source {
                ...
                ChannelMessageNameIndex::ChannelMessage(a) => SearchHit {
                    ...
                    goto: Some(SearchGotoContent::Channels(SearchGotoChannel {
                        ...
                        created_at: chrono::DateTime::from_timestamp(a.created_at_seconds, 0).unwrap_or_default(),
                        updated_at: chrono::DateTime::from_timestamp(a.updated_at_seconds, 0).unwrap_or_default(),
                    })),
