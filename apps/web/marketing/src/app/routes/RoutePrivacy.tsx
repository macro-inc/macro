...
import { UtilPlainText } from '../components/utils/UtilPlainText';
import { setPageSeo } from '../utils/utilSeo';
import './RouteLegal.css';

const content = String.raw`Macro
...
Coparse, Inc. dba Macro ("Macro," "we," "us," and "our") goal is to make productivity accessible to all. This Privacy Policy will help you understand how we collect, use and disclose your personal information and assist you in exercising the privacy rights available to you.

Capitalized terms not defined in this Privacy Policy have the meanings set forth in our Terms of Service.

## 2. SCOPE

This Privacy Policy applies to personal information processed by us, including on our websites (e.g., macro.com and any other websites that we own or operate), our mobile applications, our application program interfaces, our productivity tool services, and our related online and offline offerings (collectively, the "Services").
...
Account Information. When you create a Macro account, we collect the personal information you provide to us, such as your name, email address, personal website, and picture. If you enable phone based two-factor authentication, we collect a phone number.

Payment Information. Where we sell products and services through the Services, we use third-party applications, such as the Apple App Store, Google Play App Store, Amazon App Store, and/or services such as Stripe to process your payments. These third-party applications will collect information from you to process a payment on behalf of Macro, including your name, email address, mailing address, payment card information, and other billing information. Macro does not receive or store your payment information, but it may receive and store information associated with your payment information (e.g., the fact that you have paid, the last four digits or your credit card information, and your country of origin).
...
Customer Content. We collect applications and materials that are developed by you on the Services or uploaded to the Services by you. Customer Content may include personal information such as any names you use in your designs or your voice if you use any Macro voice features.
...
Customer Service Information (including Training and Quality Assurance). If you call or otherwise interact with Macro's sales, customer service or support personnel, we collect the information you provide to our representatives. In addition, we may record telephone calls or video conferences between you and our representatives for training or quality assurance purposes.

Student Account Information. If you qualify for Macro for Education, we may collect basic information relating to your school and curriculum, such as your school name, school mailing address, school website and proof of registration. Note that, as provided in our Terms of Service, the Services are only for users 13 years old and over.
...
## 4. INFORMATION COLLECTED AUTOMATICALLY (TECHNICAL INFORMATION)
...
Cookies, Pixel Tags/Web Beacons, and Analytics Information. We, as well as third parties that may provide content, advertising, or other functionality on or in connection with the Services, may use cookies, pixel tags, local storage, and other technologies (“Technologies”) to automatically collect information through the Services. Technologies are essentially small data files placed on your device that allow us and our partners to record certain pieces of information whenever you visit or interact with our Services. Cookies. Cookies are small text files placed in device browsers to store their preferences. For more information about how to control what data are collected by cookies, see below in the “Your Choices” section. Pixel Tags/Web Beacons. A pixel tag (also known as a web beacon) is a piece of code embedded in the Services that collects information about engagement on the Services. The use of a pixel tag allows us to record, for example, that a user has visited a particular web page or clicked on a particular advertisement. We may also include web beacons in e-mails to understand whether messages have been opened, acted on, or forwarded.
...
Macro Customers. If you use our Services on behalf of, or in collaboration with, an organization (e.g., your employer), that organization may provide us with information about you so that we can provision your account.
...
## 6. HOW WE USE YOUR INFORMATION AND OUR LEGAL BASIS FOR PROCESSING
...
responding to requests in relation to personal information processed about the individual. This includes: the processing of all categories of information except for Candidate Information.
...
This includes: the processing of your Usage Data and, if "Content Training" is toggled on within your administrative user settings, Customer Content. We take steps to de-identify and aggregate data to protect your privacy for data we use to train AI models. Click here for more information about the steps we take to protect your privacy. Additionally, we explicitly affirm that data accessed through Google Workspace APIs is not used to develop, improve, or train generalized AI and/or ML models. The use of raw or derived user data received from Workspace APIs will adhere to the Google User Data Policy, including the Limited Use requirements.
...
This includes: the processing of your Account Information, Student Account Information, Communications Information, and Usage Data. Legal Basis: Necessary for our legitimate interests (to develop our products/services and grow our business) (where consent is not required by marketing laws – in which case consent shall be relied upon).
...
This includes: the processing of your Account Information, Student Account Information, and Communication Information. Legal Basis: In certain situations, we seek consent before sending marketing materials to individuals and in such cases consent is our lawful basis for sending marketing to you. Where we do not obtain consent, we rely on our legitimate interests (to develop our products/services and grow our business) as our lawful basis for sending marketing materials to you. If you have any questions about our marketing practices or if you would like to withdraw your consent or opt out of the use of your personal information for marketing purposes, you may contact us as set out in the Contact Us section of this Privacy Policy.
...
This could include any personal information we process about you. Legal Basis: Necessary to comply with a legal obligation (including national data protection, cyber security, export control, sanctions and surveillance laws). Necessary for our legitimate interests (to enforce our agreements, to seek professional advice, or to establish, exercise or defend a legal claim).

12. Recruiting and hiring, including considering your candidacy for employment.

This includes: the processing of Candidate Information and Communication Information. Legal Basis: Necessary for our legitimate interests (to screen candidates and consider your suitability for a position). Entry into a contract with you.
...
Your Organization and Administrator. If you access the Services on behalf of an organization (such as with your organization's domain) or have your account paid for by another party, we will disclose your information to that organization or paying party at its request and give such organization certain rights over your information. For example, your organization may request that we provide extra security controls around your account to protect information about your organization or your organization may request that we link your Macro account with your organization's account to enhance collaboration. If you are the administrator of a team, organization or other account holder within the Services, we may disclose your contact information to current or past Service users related to you, for the purpose of facilitating Service-related requests. Please note that your information may also be subject to your organization's privacy policy, and we are not responsible for the privacy or security practices of our customers.
...
Disclosures to Protect Us or Others. We will access, preserve, and disclose information we have associated with you to competent law enforcement bodies, regulatory and government agencies, courts or other third parties if we believe doing so is required or appropriate to: (i) comply with law enforcement or national security requests and legal process, such as a court order or subpoena; (ii) protect your, our or others' rights, property, or safety; (iii) enforce Macro's policies and contracts; (iv) collect amounts owed to us; (v) prevent financial loss or in connection with an investigation or prosecution of suspected or actual illegal activity; or (vi) if we, in good faith, believe that disclosure is otherwise necessary or advisable.
...
This Supplemental Notice for California Residents supplements our Privacy Policy and only applies to our processing of personal information that is subject to the California Consumer Privacy Act of 2018 (as amended from time to time) ("CCPA"). The CCPA provides California residents with the right to know what categories of personal information Macro has collected about them,whether Macro disclosed that personal information for a business purpose (e.g., to a service provider), whether Macro "sold" that personal information, and whether Macro "shared" that personal information for "cross-context behavioral advertising" in the preceding 12 months. California residents can find this information above, in the respective sections of this Privacy Policy, and below:

Macro collects the following Categories of Personal Information:
...
Commercial information: Records of products or services purchased or obtained from Macro.
...
Personal information that reveals a consumer's account log-in, financial account, debit card, or credit card number in combination with any required security or access code, password, or credentials allowing access to an account: Macro account credentials, payment information. For clarification, Macro does not process your credit card information, but instead uses a third party, Stripe.

Macro Discloses to the following Categories of Third Parties for a Business Purpose:

Other users of Macro's Services
...
Under the CCPA, Macro's use of retargeting pixels or third party cookies as described above in this Privacy Policy may be considered: (1) a "sale" of personal information and/or (2) "sharing" personal information for "cross-context behavioral advertising." Based on how these terms are defined and interpreted under the CCPA, the following is a list of the categories of personal information Macro has "sold" or "shared" for "cross-context behavioral advertising" in the last twelve months:
...
Notice of Right to Opt-Out of "Sale" of Personal Information and/or "Sharing" for "Cross-Context Behavioral Advertising". California residents have the right to opt out of the "sale" of personal information and the "sharing" of personal information for "cross-context behavioral advertising." California residents may exercise these rights by clicking on the "Manage Cookies" link in the footer of macro.com (users may need to log out of their Macro account to access the footer) and following the instructions on that page.

Disclosure Regarding Individuals Under the Age of 16. Macro does not have actual knowledge of any "sale" of personal information of minors under 16 years of age. Macro does not have actual knowledge of any "sharing" of personal information of minors under 16 years of age for "cross-context behavioral advertising."

Disclosure Regarding Sensitive Personal Information. Macro only uses and discloses "sensitive personal information" as defined by the CCPA for the following purposes:
...
To resist malicious, deceptive, fraudulent, or illegal actions directed at Macro and to prosecute those responsible for those actions.
...
Non-Discrimination. California residents have the right not to receive discriminatory treatment by us for the exercise of their rights conferred by the CCPA. If you are a California resident and would like to exercise any of your rights under the CCPA (including the rights included in Section 9 of the Privacy Policy above), please contact us as set forth below. We will process such requests in accordance with applicable laws.
...
Coparse, Inc. dba Macro

54 W 21st St, Suite 503
...
This Supplemental Privacy Policy for Children governs Macro's collection, use and disclosure of personal information from children under the age of thirteen in the United States who are students of Macro's educational institution customers (each a "Child" and collectively "Children"). This Supplemental Privacy Policy for Children supplements Macro's Privacy Policy to notify parents, guardians, schools, and/or school districts (each a "Responsible Parent") of:

The types of personal information Macro may collect from Children;

How Macro uses the personal information it collects from Children;

Macro's practices for disclosing that Child's personal information;

How a Responsible Parent may request access, modification, and deletion of the Children's personal information Macro has collected.

If a school or school district has contracted with Macro to provide the services to students at its school (the "Services"), Macro relies on the school and/or school district to provide consent on behalf of each Child's parent or guardian after reviewing this Supplemental Privacy Policy for Children. If any provisions in this Supplemental Privacy Policy for Children conflict with the Privacy Policy, this Supplemental Privacy Policy for Children controls.

Personal Information Macro Collects from Children

Macro only collects personal information from a Child in connection with the creation or administration of the Child's account or when the Child uses the Services in connection with their account. Personal information that Macro collects in connection with the creation or administration of a Child's account may include the Child's first and last name, email address, IP address, photograph (if uploaded by Child for profile), phone number if 2FA is enabled, job title, and educational records or details (including those provided by a school and/or school district). In addition, if a Child communicates with Macro for support or other purposes, Macro may collect personal information from the Child.

Macro may collect certain personal information from Children automatically when they use our Services, such as Internet protocol (IP) address, user settings, cookie identifiers, mobile advertising and other unique identifiers, browser or device information, and Internet service provider. Macro may also automatically collect personal information regarding a Child's use of our Services, such as analytics about a Child's use of the Services, personal information contained in any content a Child generates using our Services, details about the Child's files created on our Services, pages that a Child visits, information about the links a Child clicks, the types of content a Child interacts with, the frequency and duration of a Child's activities, and other information about how a Child uses our Services.

How Macro Uses Children's Personal Information

Macro only uses personal information collected from Children to provide the Services.

Macro's Practices for Disclosing Children's Personal Information

Macro may disclose a Child's personal information:

To the general public., if link sharing or posting to Macro Community is turned on . Content can be made publicly available by a Child or others collaborating on it, and in such cases any information about a Child included in such content is also publicly available and can be indexed by search engines. A Child can check at any time whether particular content is public or private by viewing the content's settings. In addition, in connection with a Child's posting of content on Macro Community, Macro will publicly disclose the Child's profile picture, name, user handle, and other online handle(s) (to the extent a Child has provided us with this information). To other users of the Services that a Child disclose to or interacts with. To the teacher, school, and/or school district on whose behalf the Child uses the Services. To service providers Macro uses to provide the Services. If Macro is required to do so by law or legal process, such as to comply with any court order or subpoena or to respond to any government or regulatory request. If Macro believes the disclosure is necessary or appropriate to protect the rights, property, or safety of Macro, its customers or others, including to: protect the safety of a Child; protect the safety and security of the Services; or enable Macro to take precautions against liability. To law enforcement agencies or for an investigation related to public safety. In addition, if Macro is involved in a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Macro's assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding or event, Macro may transfer the Children's personal information it has collected or maintain to the buyer or other successor. Macro K12 Educational Accounts and Domain Capture. Macro for Education's Enterprise accounts have domain capture functionality enabled by default in order to protect against unauthorized access from users with a different email domain. With domain capture enabled your name, email and profile picture (if you upload one) will be disclosed to other users across your Macro organization. This should be noted if email domains are shared across multiple educational institutions. Third-Party Operators Our list of third-party operators that collect personal information from Children on our Services can be found at: https://www.macro.com/sub-processors/. Parental Choices and Controls At any time, a Responsible Parent may use the Services to review a Child's personal information, require Macro to correct or delete a Child's personal information, and/or refuse to permit Macro from further collecting or using a Child's personal information. Please keep in mind that a request to delete records may lead to a termination of an account and/or the Services. Responsible Parent can request assistance from Macro to change or delete Children's personal information by sending Macro an email at legal@macro.com. Macro may require that Responsible Parent take certain steps or provide additional information to verify its identity before Macro provides any information or makes corrections.`;

export const RoutePrivacy: Component = () => {
  setPageSeo({
    title: 'Privacy Policy · Macro',
    description:
      'How Macro collects, uses, and protects your personal information across our websites, apps, and services, and the choices you have about your data.',
    path: '/privacy',
  });

  return (
    <>
      <UtilPlainText content={content} />
      <div class="legal-doc-footer">
        <SectionMoreFeatures currentPath="/privacy" footerOnly />
      </div>
    </>
  );
};
