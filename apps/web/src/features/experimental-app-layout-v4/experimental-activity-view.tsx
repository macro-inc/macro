  ...
  return (
    ...
    >
      <div class="flex min-h-8 min-w-0 items-center">
        <button
          type="button"
          class="experimental-v4-view-switch flex w-40 max-w-full items-center justify-between gap-2.5 rounded-xl px-1 py-1 text-ink outline-none transition-colors hover:text-accent focus-visible:ring-2 focus-visible:ring-accent/40"
          ...
          onClick={switchView}
        >
          <span class="experimental-v4-view-switch-label">
            <span class="experimental-v4-view-switch-current-frame">
              <span class="experimental-v4-view-switch-current">
                {props.title}
              </span>
            </span>
            <span
              aria-hidden="true"
              class="experimental-v4-view-switch-next"
            >
              {destination()}
            </span>
          </span>
...
/** Combined Activity and Inbox workspace for Experimental v4. */
  ...
  return (
    <div class="@container/experimental-activity relative flex size-full min-h-0 flex-col bg-panel">
      ...
      <Suspense fallback={<div class="size-full bg-panel" />}>
        ...
        >
        <div class="flex size-full min-h-0 flex-col pt-16">
