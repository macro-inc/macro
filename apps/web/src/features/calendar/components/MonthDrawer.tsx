  ...
  return (
    ...
    >
      <MobileDrawer.Trigger
        ...
        class="max-w-full min-w-0 shrink justify-start gap-1 rounded-full border-none bg-transparent px-1 text-base font-semibold text-ink not-touch:hover:bg-hover"
      >
