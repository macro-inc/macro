  ...
  return (
    <>
      <div class="size-full overflow-y-auto bg-surface text-ink">
        ...
        <main class="mx-auto w-full max-w-[560px] px-8 pt-14 pb-24 mobile:px-5 mobile:pt-[calc(var(--mobile-content-inset-top,0px)+2rem)] mobile:pb-[calc(var(--mobile-content-inset-bottom,0px)+3rem)]">
          <Button
            type="button"
            variant="ghost"
            size="sm"
