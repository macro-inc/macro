...
function ActivityWorkspaceHeader() {
  return (
    <ComposedSplitHeader class="absolute! left-0 top-0 z-1 flex flex-col items-stretch px-4 pb-3 pt-2 @max-[760px]/experimental-activity:px-3 @max-[480px]/experimental-activity:px-2">
      <div class="flex min-h-8 min-w-0 items-center px-1">
        <h1 class="truncate text-2xl font-semibold leading-8 tracking-[-0.035em] text-ink">
          Activity
        </h1>
      </div>
    </ComposedSplitHeader>
...
/** Activity workspace for Experimental v6. */
