...
import type { HomeTab, HomeTypeFilter } from '../types';
import type { HomeQueryCapabilities, HomeViewContext } from './home-query';

const tabTypes: Record<HomeTab, ReadonlySet<HomeTypeFilter>> = {
  signal: new Set([
    'documents',
    'tasks',
    'email',
...
/** Mirrors Home tab/type/read semantics for service-backed search. */
export function buildHomeSearchRequest(
