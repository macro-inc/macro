...
export function homePreviewNavigation(
  selection: PreviewPanelSelection
): HomePreviewNavigation {
  return homePreviewTargetNavigation(previewBlockTarget(selection));
}
