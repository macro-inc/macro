...
function CollapsibleSectionHeader(props: {
  ...
  return (
    <div
      class={cn(
        'group/section-header flex w-full items-center rounded-xl text-xs font-semibold uppercase tracking-wide text-ink-extra-muted transition-colors hover:text-ink-muted',
