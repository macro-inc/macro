...
export type DatabaseRowsSnapshot = { rows: DatabaseRow[]; version: number | undefined };
export type DatabaseWriteResult = { insertedRowIds: string[]; version: number | undefined };
...
export type DatabaseRowsSource = {
  ...
  write(mutation: DatabaseRowMutation, version: number | undefined): Promise<DatabaseWriteResult>;
