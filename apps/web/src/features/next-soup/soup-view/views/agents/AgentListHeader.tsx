 ...
 * labels line up with each row's status / model / harness values. Columns
 * are read-only — sessions keep the list's recency ordering.
 */
function AgentListHeader(props: { class?: string }) {
  return (
    <div
      ...
      class={cn(
        'agent-grid-row w-full grid items-center gap-2 px-3 h-10',
    ...
    >
      ...
      <div
        ...
        class="flex items-center justify-end min-w-0 truncate"
      >
        Updated
      </div>
    </div>
