...
describe('inbox view presets', () => {
  it('orders the notification tabs by latest notification', () => {
    ...
    expect(getViewPreset('inbox', 'signal')?.sortMethod).toBe('notified_at');
    expect(getViewPreset('inbox', 'noise')?.sortMethod).toBe('notified_at');
  });
  ...
  it('keeps recency ordering on the other tabs', () => {
    ...
    expect(getViewPreset('inbox', 'all')?.sortMethod).toBe('updated_at');
    expect(getViewPreset('inbox', 'reminders')?.sortMethod).toBe('updated_at');
  });
