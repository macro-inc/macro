...
import Erase from '@lucide/eraser.svg';
import MirrorX from '@lucide/flip-horizontal.svg';
import MirrorY from '@lucide/flip-vertical.svg';
import Fill from '@lucide/paint-bucket.svg';
import Pencil from '@lucide/pencil.svg';
import Plus from '@lucide/plus.svg';
import Rotate from '@lucide/rotate-ccw.svg';
import Upload from '@lucide/square-arrow-out-up-left.svg';
