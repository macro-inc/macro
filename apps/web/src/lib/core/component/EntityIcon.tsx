...
import WideBook from '@lucide/book.svg';
import Robot from '@lucide/bot.svg';
import Building from '@lucide/building.svg';
import WideCalendar from '@lucide/calendar.svg';
import Check from '@lucide/check.svg';
import WideUnknown from '@lucide/circle-help.svg';
import FileCode from '@lucide/code.svg';
import File from '@lucide/file.svg';
import FileArchive from '@lucide/file-archive.svg';
import FileHtml from '@lucide/file-code.svg';
import FileDoc from '@lucide/file-text.svg';
import FileMd from '@lucide/file-text.svg';
import FilePdf from '@lucide/file-text.svg';
import FileVideo from '@lucide/file-video.svg';
import Files from '@lucide/files.svg';
import Folder from '@lucide/folder.svg';
import FolderUser from '@lucide/folder-open.svg';
import WideGlobe from '@lucide/globe.svg';
import GlobeIcon from '@lucide/globe.svg';
import FileImage from '@lucide/image.svg';
import Email from '@lucide/mail.svg';
import EmailRead from '@lucide/mail-open.svg';
import Chat from '@lucide/message-square.svg';
import Canvas from '@lucide/square-pen.svg';
import Users from '@lucide/users.svg';
import WideVideo from '@lucide/video.svg';
