...
export function OldMenu(props: ParentProps<OldMenuProps>) {
  return (
    <div
      class={cn(
        'flex flex-col py-1 justify-start items-start border border-edge bg-menu-glass [--color-surface:var(--color-menu)] glass-lg rounded-md cursor-default select-none',
