...
type GraphqlHistoryItemFields_GraphqlSoupCall_Fragment = { __typename: 'GraphqlSoupCall' };

type GraphqlHistoryItemFields_GraphqlSoupChannel_Fragment = { __typename: 'GraphqlSoupChannel' };

type GraphqlHistoryItemFields_GraphqlSoupChannelThread_Fragment = { __typename: 'GraphqlSoupChannelThread' };

type GraphqlHistoryItemFields_GraphqlSoupChat_Fragment = { __typename: 'GraphqlSoupChat', id: string, name: string, ownerId: string, isPersistent: boolean, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null };

type GraphqlHistoryItemFields_GraphqlSoupCrmCompany_Fragment = { __typename: 'GraphqlSoupCrmCompany' };

type GraphqlHistoryItemFields_GraphqlSoupDocument_Fragment = { __typename: 'GraphqlSoupDocument', id: string, name: string, ownerId: string, fileType: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, subType: { kind: string, isCompleted: boolean | null } | null };

type GraphqlHistoryItemFields_GraphqlSoupEmailThread_Fragment = { __typename: 'GraphqlSoupEmailThread' };

type GraphqlHistoryItemFields_GraphqlSoupForeignEntity_Fragment = { __typename: 'GraphqlSoupForeignEntity' };

type GraphqlHistoryItemFields_GraphqlSoupProject_Fragment = { __typename: 'GraphqlSoupProject', id: string, name: string, ownerId: string, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null };
...
export type GraphqlHistoryItemFieldsFragment =
  ...
  | GraphqlHistoryItemFields_GraphqlSoupChannelThread_Fragment
