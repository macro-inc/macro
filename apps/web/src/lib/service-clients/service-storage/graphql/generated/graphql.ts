...
export type EntityMutationRefFieldsFragment = { entityType: GraphqlEntityType, id: string };

type EntityMutationResultFields_GraphqlMutationError_Fragment = { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string };

type EntityMutationResultFields_GraphqlMutationSuccess_Fragment = { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> };

export type EntityMutationResultFieldsFragment =
  | EntityMutationResultFields_GraphqlMutationError_Fragment
  | EntityMutationResultFields_GraphqlMutationSuccess_Fragment
;

export type EntityMutationPayloadFieldsFragment = { results: Array<
    | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
    | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
  > };
...
export type RenameEntitiesMutation = { renameEntities: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type MoveEntitiesMutation = { moveEntities: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type UpdateEntitySharePoliciesMutation = { updateEntitySharePolicies: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type TrashEntitiesMutation = { trashEntities: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type RestoreEntitiesMutation = { restoreEntities: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type DeleteEntitiesPermanentlyMutation = { deleteEntitiesPermanently: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type DuplicateEntitiesMutation = { duplicateEntities: { results: Array<
      | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
      | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
    > } };
...
export type SetEntityFavoriteMutation = { setEntityFavorite:
    | { __typename: 'GraphqlMutationError', errorCode: GraphqlEntityMutationErrorCode, message: string }
    | { __typename: 'GraphqlMutationSuccess', affectedEntities: Array<{ entityType: GraphqlEntityType, id: string }> }
   };
...
type GraphqlHistoryItemFields_GraphqlSoupChannel_Fragment = { __typename: 'GraphqlSoupChannel', id: string, channelType: string, ownerId: string, organizationId: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, interactedAt: string | null, entityType: GraphqlSoupEntityType, frecencyScore: number | null, channelName: string | null, channelTeamId: string | null, participants: Array<{ channelId: string, userId: string, role: string, joinedAt: string, leftAt: string | null }>, latestMessage: { messageId: string, channelId: string, threadId: string | null, senderId: string, content: string, createdAt: string, updatedAt: string, deletedAt: string | null, mentions: Array<string> } | null, latestNonThreadMessage: { messageId: string, channelId: string, threadId: string | null, senderId: string, content: string, createdAt: string, updatedAt: string, deletedAt: string | null, mentions: Array<string> } | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> };

type GraphqlHistoryItemFields_GraphqlSoupChannelMessage_Fragment = { __typename: 'GraphqlSoupChannelMessage', id: string, channelId: string, senderId: string, content: string, createdAt: string, updatedAt: string, effectiveUpdatedAt: string, replyCount: number, entityType: GraphqlSoupEntityType, frecencyScore: number | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> };

type GraphqlHistoryItemFields_GraphqlSoupChat_Fragment = { __typename: 'GraphqlSoupChat', id: string, ownerId: string, projectId: string | null, isPersistent: boolean, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, entityType: GraphqlSoupEntityType, frecencyScore: number | null, chatName: string, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
      | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
      | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
      | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
      | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
...
type GraphqlHistoryItemFields_GraphqlSoupCrmCompany_Fragment = { __typename: 'GraphqlSoupCrmCompany', id: string, description: string | null, emailSync: boolean, hidden: boolean, createdAt: string, updatedAt: string, viewedAt: string | null, domains: Array<string>, entityType: GraphqlSoupEntityType, frecencyScore: number | null, crmTeamId: string, crmCompanyName: string | null, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
      | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
      | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
      | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
      | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
...
type GraphqlHistoryItemFields_GraphqlSoupEmailThread_Fragment = { __typename: 'GraphqlSoupEmailThread', attachmentCount: number, participantCount: number, id: string, entityType: GraphqlSoupEntityType, frecencyScore: number | null };

type GraphqlHistoryItemFields_GraphqlSoupForeignEntity_Fragment = { __typename: 'GraphqlSoupForeignEntity', id: string, foreignEntityId: string, foreignEntitySource: string, storedForId: string, storedForAuthEntity: string, sourceMetadata: unknown, createdAt: string, updatedAt: string, entityType: GraphqlSoupEntityType, frecencyScore: number | null, notifications: Array<{ id: string, eventType: string, entityType: GraphqlSoupEntityType, entityId: string, sent: boolean, done: boolean, seen: boolean, createdAt: string, viewedAt: string | null, updatedAt: string, senderId: string | null, metadata: unknown }> };

type GraphqlHistoryItemFields_GraphqlSoupProject_Fragment = { __typename: 'GraphqlSoupProject', id: string, ownerId: string, parentId: string | null, createdAt: string, updatedAt: string, viewedAt: string | null, deletedAt: string | null, entityType: GraphqlSoupEntityType, frecencyScore: number | null, projectName: string, properties: Array<{ id: string, propertyDefinitionId: string, displayName: string, dataType: GraphqlPropertyDataType, isMultiSelect: boolean, specificEntityType: GraphqlPropertyEntityType | null, isSystem: boolean, isMetadata: boolean, value:
      | { __typename: 'GraphqlBooleanPropertyValue', boolValue: boolean }
      | { __typename: 'GraphqlDatePropertyValue', dateValue: string }
      | { __typename: 'GraphqlEntityReferencePropertyValue', references: Array<{ entityId: string, entityType: GraphqlPropertyEntityType, specificMessageId: string | null }> }
      | { __typename: 'GraphqlLinkPropertyValue', urls: Array<string> }
...
export type GraphqlHistoryItemFieldsFragment =
  ...
  | GraphqlHistoryItemFields_GraphqlSoupChat_Fragment
  | GraphqlHistoryItemFields_GraphqlSoupCrmCompany_Fragment
  | GraphqlHistoryItemFields_GraphqlSoupDocument_Fragment
...
export type SoupUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;
