...
- New features use the layered layout in docs/STYLE_GUIDE.md FE-31 (`core / queries / primitives / components / views` plus an injected `context/`). `src/features/activity` is the reference.
