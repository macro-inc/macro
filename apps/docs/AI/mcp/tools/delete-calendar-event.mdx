...
| `calendarId` | string | No | The `calendarId` of the copy to delete, from its ListCalendarEvents entry, for an event synced from more than one calendar. Omit to delete the event's primary copy. |
