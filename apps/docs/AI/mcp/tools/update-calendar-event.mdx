...
| `calendarId` | string | No | The `calendarId` of the copy to update, from its ListCalendarEvents entry, for an event synced from more than one calendar. Omit to update the event's primary copy. |
