...
| `userConfirmation` | string | Yes | The user's own message approving this specific email, quoted verbatim - for example their "yes, send it" after you described the email in prose. Required: do not call this tool without one, do not paraphrase it, and never supply it yourself. |
