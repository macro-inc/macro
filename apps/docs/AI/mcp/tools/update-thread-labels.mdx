...
| --- | --- | --- | --- |
| `thread_id` | string | Yes | The ID of the email thread to modify. Same UUID returned by QuerySoup, search, or GetThread. |
