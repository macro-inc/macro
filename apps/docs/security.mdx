...
If you need audit reports, a data processing agreement, or answers to a security questionnaire as part of a vendor review, email [security@macro.com](mailto:security@macro.com).

<Note>
  For HIPAA, FedRAMP, or other requirements that need Macro running inside your own infrastructure, contact [self-host@macro.com](mailto:self-host@macro.com). Self-hosting under the AGPLv3 is covered in the [FAQ](/faq).
</Note>

## Data storage and regions

The hosted version of Macro runs on **AWS in the United States**. There is currently no option to pin a workspace to another region — if regional data residency is a hard requirement for you, self-hosting is the path today, and [self-host@macro.com](mailto:self-host@macro.com) is the place to start.

Your data is stored across a few systems, all inside that same AWS environment:
...
<AccordionGroup>
  ...
  <Accordion title="Can I keep my data in the EU?">
    Not on the hosted version — it runs on AWS in the US. Self-hosting is the option today; email [self-host@macro.com](mailto:self-host@macro.com).
  </Accordion>
