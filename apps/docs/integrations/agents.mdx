...
<Steps>
  ...
  <Step title="Download macrod">
    Open the [latest Macro release](https://github.com/macro-inc/macro/releases/latest) and download the `macrod` archive for your OS/architecture. Right now we only officially support Mac and Linux.
  </Step>
...
Both `macrod` and your HTTPS tunnel must stay running for you to be able to start self-hosted agent sessios from Macro.
