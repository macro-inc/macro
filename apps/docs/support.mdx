...
For specific topics: [licensing@macro.com](mailto:licensing@macro.com) for commercial licensing, [support@macro.com](mailto:support@macro.com) for a DPA, a HIPAA BAA, or EU hosting, [self-host@macro.com](mailto:self-host@macro.com) for FedRAMP and self-hosted deployments, [security@macro.com](mailto:security@macro.com) for vulnerability reports and vendor security reviews (see [Security](/security)), and [teo@macro.com](mailto:teo@macro.com) if you want to contribute but aren't sure where to start.
