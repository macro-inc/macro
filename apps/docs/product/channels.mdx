...
> To create a channel use shortcut <kbd>c</kbd> \+ <kbd>g</kbd>

New channels function similarly to Slack channels. You can have an empty channel with just yourself, or add team members for a collaborative channel.

<Frame>
  ![New channel creation dialog](/images/new_channel_ui.png)
</Frame>

> To create a new message use shortcut <kbd>c</kbd> \+ <kbd>m</kbd>

A new message sends in an existing channel if you already have one with those recipients, or creates a new channel if one does not exist yet.
