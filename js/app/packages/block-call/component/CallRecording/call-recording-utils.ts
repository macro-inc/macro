...
export const CALL_META_STRIP_TOGGLE_IDLE =
  'flex shrink-0 items-center gap-1.5 rounded-xs border border-edge-muted px-2 py-1.5 text-xs font-medium text-ink-muted transition-colors hover:bg-hover0 hover:text-ink focus-visible:outline-none';
