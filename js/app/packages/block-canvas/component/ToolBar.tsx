...
import Hand from '@icon/hand.svg';
import ZoomOut from '@icon/magnifying-glass-minus.svg';
import ZoomIn from '@icon/magnifying-glass-plus.svg';
import PencilSimple from '@icon/pencil-simple.svg';
import Rectangle from '@icon/rectangle.svg';
import Text from '@icon/text-t.svg';
