...
export function Keyboard() {
  return (
    ...
    >
      ...
      <KeyRect binding="delete"    x={26.0763} y={ 2.0763} width={2.8473} height={1.8473} labelX={27.50} labelY={ 3.0228} />
      {/* Row 3: QWERTY row */}
      ...
      {/* Row 4: Home row */}
      <KeyRect binding="caps lock" x={ 0.0763} y={ 6.0763} width={3.3473} height={1.8473} labelX={ 1.75} labelY={ 7.0228} />
      ...
      <KeyRect binding="shift-l"   x={ 0.0763} y={ 8.0763} width={4.3473} height={1.8473} labelX={ 2.25} labelY={ 9.0228} />
      ...
      <KeyRect binding="shift-r"   x={24.5763} y={ 8.0763} width={4.3473} height={1.8473} labelX={26.75} labelY={ 9.0228} />
      {/* Row 6: Bottom row */}
      <KeyRect binding="fn"        x={ 0.0763} y={10.0763} width={1.8473} height={1.8473} labelX={ 1.00} labelY={11.0228} />
      <KeyRect binding="control"   x={ 2.0763} y={10.0763} width={1.8473} height={1.8473} labelX={ 3.00} labelY={11.0228} />
      <KeyRect binding="option-l"  x={ 4.0763} y={10.0763} width={1.8473} height={1.8473} labelX={ 5.00} labelY={11.0228} />
      <KeyRect binding="command-l" x={ 6.0763} y={10.0763} width={2.3473} height={1.8473} labelX={ 7.25} labelY={11.0228} />
      <KeyRect binding="spacebar"  x={ 8.5763} y={10.0763} width={9.8473} height={1.8473} labelX={13.50} labelY={11.0228} />
      <KeyRect binding="command-r" x={18.5763} y={10.0763} width={2.3473} height={1.8473} labelX={19.75} labelY={11.0228} />
      <KeyRect binding="option-r"  x={21.0763} y={10.0763} width={1.8473} height={1.8473} labelX={22.00} labelY={11.0228} />
      <KeyRect binding="arrow-l"   x={23.0763} y={10.0763} width={1.8473} height={1.8473} labelX={24.00} labelY={11.0228} />
      <KeyRect binding="arrow-u"   x={25.0763} y={10.0763} width={1.8473} height={0.8473} labelX={26.00} labelY={10.5000} />
      <KeyRect binding="arrow-d"   x={25.0763} y={11.0763} width={1.8473} height={0.8473} labelX={26.00} labelY={11.5000} />
      <KeyRect binding="arrow-r"   x={27.0763} y={10.0763} width={1.8473} height={1.8473} labelX={28.00} labelY={11.0228} />
    </svg>
  );
}
