      ...
      <button
        ...
        class={cn(
          ...
          !local.suppressInteractionStyling &&
            'hover:bg-hover focus:[--focus-border-inset:-4px] active:border-accent active:bg-accent active:text-panel disabled:opacity-20 disabled:pointer-events-none disabled:hover:bg-inherit',
