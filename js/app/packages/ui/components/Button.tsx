      ...
      <button
        ...
        class={cn(
          ...
          !local.suppressInteractionStyling &&
            'hover:bg-hover focus:[--focus-border-inset:-4px] active:border-accent active:bg-accent active:text-panel disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-inherit',
