...
import { AnimatedChatIcon } from '@icon/wide/animating/chat';
import { AnimatedDiagramIcon } from '@icon/wide/animating/diagram';
import { AnimatedEmailIcon } from '@icon/wide/animating/email';
import { AnimatedFileCodeIcon } from '@icon/wide/animating/fileCode';
