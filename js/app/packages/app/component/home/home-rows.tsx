...
/** Interactive card row shared by the home / new-chat sections. */
export const ROW =
...
/** Non-interactive variant of {@link ROW} (no hover treatment). */
export const STATIC_ROW =
  'group flex w-full items-center gap-3.5 rounded-xl border border-edge-muted bg-active px-4 py-3 text-left';

/** Square icon tile that leads a {@link SetupRow}. */
export const TILE =
  'flex size-7 shrink-0 items-center justify-center rounded-lg bg-surface text-ink-muted';
...
export function SetupRow(props: {
  ...
  return (
    <Switch fallback={<div class={STATIC_ROW}>{inner}</div>}>
