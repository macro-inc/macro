...
import { AnimatedCallIcon } from '@icon/wide/animating/call';
...
import { AnimatedInboxIcon } from '@icon/wide/animating/inbox';
import { AnimatedNewSplitIcon } from '@icon/wide/animating/newSplit';
import { AnimatedPlusIcon } from '@icon/wide/animating/plus';
import { AnimatedSearchIcon } from '@icon/wide/animating/search';
import { AnimatedSidebarIcon } from '@icon/wide/animating/sidebar';
