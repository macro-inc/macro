        ...
        <KSelect.Content class="z-action-menu bg-surface-0 border border-edge-muted rounded-sm shadow min-w-[var(--kb-popper-anchor-width)] p-1">
          ...
          <div class="w-full pt-1 mt-1 flex items-center border-t border-t-edge-muted">
            <Button
              variant="ghost"
              size="sm"
              class="ml-auto w-full rounded-xs"
    ...
    >
      <Combobox.Control class="flex h-full">
        <Combobox.Trigger
          ...
          size="sm"
          class={cn(
            'relative transition-none h-full rounded-xs',
            hasActiveFilters() &&
              'bg-accent/15 text-accent border border-accent/30 hover:bg-accent/25'
          )}
        >
      ...
      <Combobox.Portal>
        <Combobox.Content
          class="z-action-menu bg-surface-0 border border-edge-muted rounded-xs shadow min-w-[220px] overflow-hidden"
