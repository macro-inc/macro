...
> = (props) => {
  ...
  return (
    <KSegmentedControl
      class="size-full text-sm rounded-xs border border-edge-muted p-0.5 relative"
      value={props.value}
            ...
            {(item) => {
              ...
              return (
                ...
                >
                  ...
                  <KSegmentedControl.ItemLabel class="relative text-ink-muted size-full px-2 py-1 text-xs font-medium data-[checked]:text-ink data-[checked]:bg-ink/7 data-[checked]:rounded-[2px] transition-colors duration-150 block hover:text-ink hover:bg-ink/10 rounded-[2px]">
                    {itemLabel()}
