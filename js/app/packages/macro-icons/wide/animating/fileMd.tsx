export const FileMdIcon = (props: { triggerAnimation?: boolean }) => {
  return (
    ...
    >
      ...
      `}</style>
      <path class="upper-l" d="M17.25 0H1.5V1.5H16.5V10.5H18V0.75C18 0.34 17.66 0 17.25 0Z"/>
      <path class="lower-l" d="M1.5 1.5H0V11.25C0 11.66 0.34 12 0.75 12H16.5V10.5H1.5V1.5Z"/>
