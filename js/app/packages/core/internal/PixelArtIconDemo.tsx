...
import Rotate from '@icon/arrow-counter-clockwise.svg';
import Upload from '@icon/arrow-square-in.svg';
import Copy from '@icon/copy.svg';
import Download from '@icon/download.svg';
import Erase from '@icon/eraser.svg';
import MirrorX from '@icon/flip-horizontal.svg';
import MirrorY from '@icon/flip-vertical.svg';
import Fill from '@icon/paint-bucket.svg';
