...
const SMALL_ITEM_HEIGHT = 'h-[37px] ';
const LARGE_ITEM_HEIGHT = 'h-[54px] ';

const SMALL_BLOCK_ICON = 'sm';
const LARGE_BLOCK_ICON = 'md';

// Enumerate the background styles for selected-state items.
const defaultFileColor = 'bg-hover/20 group/item';

const fileTypeColors: Record<
