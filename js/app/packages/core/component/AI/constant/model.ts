...
export { Model as AllModels } from '@service-cognition/generated/schemas/model';

export const MODEL_PRETTYNAME: Partial<Record<Model, string>> = {
  'claude-opus-4-6': 'Claude Opus 4.6',
  'claude-haiku-4-5': 'Claude Haiku 4.5',
} as const;

export const MODEL_PROVIDER_ICON: Partial<Record<Model, any>> = {
