...
export type UploadFileInput = File | UploadFile;
...
export function isUploadFile(file: UploadFileInput): file is UploadFile {
	return "kind" in file;
}

export function ensureUploadFile(file: UploadFileInput): UploadFile {
	return isUploadFile(file) ? file : createUploadFile(file);
}
