...
export type getMacrosHandlerResponseError = (
  | getMacrosHandlerResponse401
  | getMacrosHandlerResponse404
  | getMacrosHandlerResponse500
) & {
  headers: Headers;
};

export type getMacrosHandlerResponse =
  | getMacrosHandlerResponseSuccess
  | getMacrosHandlerResponseError;

export const getGetMacrosHandlerUrl = () => {
  return `/macros`;
};

export const getMacrosHandler = async (
  options?: RequestInit
): Promise<getMacrosHandlerResponse> => {
...
export type createMacroHandlerResponseSuccess =
  createMacroHandlerResponse201 & {
    headers: Headers;
  };
export type createMacroHandlerResponseError = (
  | createMacroHandlerResponse401
  | createMacroHandlerResponse404
  | createMacroHandlerResponse500
) & {
  headers: Headers;
};

export type createMacroHandlerResponse =
  | createMacroHandlerResponseSuccess
  | createMacroHandlerResponseError;

export const getCreateMacroHandlerUrl = () => {
  return `/macros`;
};

export const createMacroHandler = async (
  createMacroRequest: CreateMacroRequest,
  options?: RequestInit
): Promise<createMacroHandlerResponse> => {
...
export type getMacroHandlerResponseError = (
  | getMacroHandlerResponse401
  | getMacroHandlerResponse404
  | getMacroHandlerResponse500
) & {
  headers: Headers;
};

export type getMacroHandlerResponse =
  | getMacroHandlerResponseSuccess
  | getMacroHandlerResponseError;

export const getGetMacroHandlerUrl = (macroPromptId: string) => {
  return `/macros/${macroPromptId}`;
};

export const getMacroHandler = async (
  macroPromptId: string,
  options?: RequestInit
): Promise<getMacroHandlerResponse> => {
...
export type deleteMacroHandlerResponseSuccess =
  deleteMacroHandlerResponse200 & {
    headers: Headers;
  };
export type deleteMacroHandlerResponseError = (
  | deleteMacroHandlerResponse401
  | deleteMacroHandlerResponse404
  | deleteMacroHandlerResponse500
) & {
  headers: Headers;
};

export type deleteMacroHandlerResponse =
  | deleteMacroHandlerResponseSuccess
  | deleteMacroHandlerResponseError;

export const getDeleteMacroHandlerUrl = (macroPromptId: string) => {
  return `/macros/${macroPromptId}`;
};

export const deleteMacroHandler = async (
  macroPromptId: string,
  options?: RequestInit
): Promise<deleteMacroHandlerResponse> => {
...
export type patchMacroHandlerResponseError = (
  | patchMacroHandlerResponse401
  | patchMacroHandlerResponse404
  | patchMacroHandlerResponse500
) & {
  headers: Headers;
};

export type patchMacroHandlerResponse =
  | patchMacroHandlerResponseSuccess
  | patchMacroHandlerResponseError;

export const getPatchMacroHandlerUrl = (macroPromptId: string) => {
  return `/macros/${macroPromptId}`;
};

export const patchMacroHandler = async (
  macroPromptId: string,
  patchMacroRequest: PatchMacroRequest,
  options?: RequestInit
): Promise<patchMacroHandlerResponse> => {
  const res = await fetch(getPatchMacroHandlerUrl(macroPromptId), {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patchMacroRequest),
  });
...
export type getMacroPermissionsHandlerResponseSuccess =
  getMacroPermissionsHandlerResponse200 & {
    headers: Headers;
  };
export type getMacroPermissionsHandlerResponseError = (
  | getMacroPermissionsHandlerResponse404
  | getMacroPermissionsHandlerResponse500
) & {
  headers: Headers;
};

export type getMacroPermissionsHandlerResponse =
  | getMacroPermissionsHandlerResponseSuccess
  | getMacroPermissionsHandlerResponseError;

export const getGetMacroPermissionsHandlerUrl = (macroPromptId: string) => {
  return `/macros/${macroPromptId}/permissions`;
};

export const getMacroPermissionsHandler = async (
  macroPromptId: string,
  options?: RequestInit
): Promise<getMacroPermissionsHandlerResponse> => {
  ...
  const data: getMacroPermissionsHandlerResponse['data'] = body
    ? JSON.parse(body)
    : {};
  return {
    data,
    status: res.status,
    headers: res.headers,
  } as getMacroPermissionsHandlerResponse;
};
