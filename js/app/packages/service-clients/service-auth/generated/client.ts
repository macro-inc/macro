...
export type refreshResponseError = (refreshResponse400 | refreshResponse401 | refreshResponse429 | refreshResponse500) & {
  headers: Headers;
};
...
export type initGithubLinkResponseError = (initGithubLinkResponse400 | initGithubLinkResponse401 | initGithubLinkResponse429 | initGithubLinkResponse500) & {
  headers: Headers;
};

export type initGithubLinkResponse = (initGithubLinkResponseSuccess | initGithubLinkResponseError)
...
export const initGithubLink = async ( options?: RequestInit): Promise<initGithubLinkResponse> => {
  ...
  return { data, status: res.status, headers: res.headers } as initGithubLinkResponse
}
...
export type getReferralCodeResponseError = (getReferralCodeResponse401 | getReferralCodeResponse500) & {
  headers: Headers;
};
...
export const getReferralCode = async ( options?: RequestInit): Promise<getReferralCodeResponse> => {
  ...
  return { data, status: res.status, headers: res.headers } as getReferralCodeResponse
}
...
export type sendReferralCodeResponseError = (sendReferralCodeResponse401 | sendReferralCodeResponse500) & {
  headers: Headers;
};

export type sendReferralCodeResponse = (sendReferralCodeResponseSuccess | sendReferralCodeResponseError)
...
export const sendReferralCode = async (sendInviteBody: SendInviteBody, options?: RequestInit): Promise<sendReferralCodeResponse> => {
  ...
  return { data, status: res.status, headers: res.headers } as sendReferralCodeResponse
}
...
export type deleteTeamInviteHandlerResponseSuccess = (deleteTeamInviteHandlerResponse200) & {
  headers: Headers;
};
export type deleteTeamInviteHandlerResponseError = (deleteTeamInviteHandlerResponse400 | deleteTeamInviteHandlerResponse401 | deleteTeamInviteHandlerResponse404 | deleteTeamInviteHandlerResponse500) & {
  headers: Headers;
};

export type deleteTeamInviteHandlerResponse = (deleteTeamInviteHandlerResponseSuccess | deleteTeamInviteHandlerResponseError)

export const getDeleteTeamInviteHandlerUrl = (teamId: string,
    teamInviteId: string,) => {
...
export const deleteTeamInviteHandler = async (teamId: string,
    teamInviteId: string, options?: RequestInit): Promise<deleteTeamInviteHandlerResponse> => {
  ...
  const data: deleteTeamInviteHandlerResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as deleteTeamInviteHandlerResponse
}
...
export type removeUserFromTeamResponseError = (removeUserFromTeamResponse400 | removeUserFromTeamResponse401 | removeUserFromTeamResponse500) & {
  headers: Headers;
};
...
export type createCheckoutSessionResponseError = (createCheckoutSessionResponse400 | createCheckoutSessionResponse404 | createCheckoutSessionResponse409 | createCheckoutSessionResponse500) & {
  headers: Headers;
};
...
export type createPortalSessionResponseError = (createPortalSessionResponse400 | createPortalSessionResponse500) & {
  headers: Headers;
};
...
export const createPortalSession = async (createPortalSessionRequest: CreatePortalSessionRequest, options?: RequestInit): Promise<createPortalSessionResponse> => {
  ...
  const data: createPortalSessionResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as createPortalSessionResponse
}
