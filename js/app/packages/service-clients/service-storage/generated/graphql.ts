...
export type GraphqlCallStatus = 'ATTENDED' | 'MISSED' | 'UNATTENDED';
...
export type GraphqlChatRole = 'ASSISTANT' | 'SYSTEM' | 'USER';
...
export type GraphqlDocumentLiteral =
  | {
      ...
      id?: never;
      importance?: never;
      includeCbmAtmNc?: never;
      isEmailAttachment?: never;
      notificationDone?: never;
      notificationSeen?: never;
      owner?: never;
      projectId?: never;
...
export type GraphqlDocumentSubType = 'SNIPPET' | 'TASK';
...
export type GraphqlSharedEmailFilter = 'EXCLUDE' | 'INCLUDE' | 'ONLY';
...
export type SoupPropertyFieldsFragment = {
  id: string;
  displayName: string;
  dataType: string;
  isMultiSelect: boolean;
...
export type SoupChannelMessageFieldsFragment = {
  messageId: string;
  threadId: string | null;
  senderId: string;
  content: string;
...
export const SoupPropertyFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'SoupPropertyFields' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'GraphqlSoupProperty' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'isMultiSelect' } },
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'specificEntityType' },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'isSystem' } },
          { kind: 'Field', name: { kind: 'Name', value: 'isMetadata' } },
          {
            kind: 'Field',
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'boolValue' } },
                { kind: 'Field', name: { kind: 'Name', value: 'numberValue' } },
                { kind: 'Field', name: { kind: 'Name', value: 'stringValue' } },
                { kind: 'Field', name: { kind: 'Name', value: 'dateValue' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'selectOptionIds' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'entityReferences' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'specificMessageId' },
                      },
                    ],
                  },
                },
...
} as unknown as DocumentNode<SoupPropertyFieldsFragment, unknown>;
export const SoupChannelMessageFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'SoupChannelMessageFields' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'GraphqlSoupChannelMessage' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<SoupChannelMessageFieldsFragment, unknown>;
export const SoupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'Soup' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'SoupInput' },
            },
          },
        },
      ],
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'frecencyScore' },
                      },
                      {
                        kind: 'Field',
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: 'Field',
                                    alias: { kind: 'Name', value: 'chatName' },
                                    name: { kind: 'Name', value: 'name' },
                                  },
                                  {
                                    kind: 'Field',
                            ...
                            },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: 'Field',
                                    alias: { kind: 'Name', value: 'emailName' },
                                    name: { kind: 'Name', value: 'name' },
                                  },
                                  {
                                    kind: 'Field',
                                      ...
                                      selections: [
                                        {
                                          ...
                                          name: {
                                            kind: 'Name',
                                            value: 'SoupChannelMessageFields',
                                          },
                                        },
                                      ],
                                    },
                            ...
                            },
                            {
                              ...
                              typeCondition: {
                                ...
                                name: {
                                  kind: 'Name',
                                  value: 'GraphqlSoupChannelThread',
                                },
                              },
                              selectionSet: {
                                kind: 'SelectionSet',
                            ...
                            },
                            {
                              ...
                              selectionSet: {
                                ...
                                selections: [
                                  ...
                                  {
                                    kind: 'Field',
                                    alias: { kind: 'Name', value: 'crmTeamId' },
                                    name: { kind: 'Name', value: 'teamId' },
                                  },
                                  {
                                    kind: 'Field',
                                  ...
                                  {
                                    kind: 'Field',
                                    name: { kind: 'Name', value: 'emailSync' },
                                  },
                                  {
                                    kind: 'Field',
                            ...
                            },
                            {
                              ...
                              typeCondition: {
                                ...
                                name: {
                                  kind: 'Name',
                                  value: 'GraphqlSoupForeignEntity',
                                },
                              },
                              selectionSet: {
                                kind: 'SelectionSet',
...
} as unknown as DocumentNode<SoupQuery, SoupQueryVariables>;
