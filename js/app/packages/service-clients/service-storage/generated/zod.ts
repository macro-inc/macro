...
export const getRecentActivityHandlerResponse = zod.object({
  ...
  "isCompleted": zod.boolean().describe('Whether the task is completed (only relevant when sub_type is \'task\').\nTrue if the Status property is set to \"Completed\", false otherwise.'),
...
export const getBatchPreviewHandlerResponse = zod.object({
  ...
  "is_completed": zod.boolean().describe('Whether the task is completed (only relevant when sub_type is \'task\').\nTrue if the Status property is set to \"Completed\", false otherwise.'),
