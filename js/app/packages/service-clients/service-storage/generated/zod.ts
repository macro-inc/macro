...
export const resolveChannelMessageParams = zod.object({
  channel_id: zod.string().uuid().describe('Channel ID'),
  message_id: zod.string().uuid().describe('Message ID to resolve'),
});
...
export const resolveChannelMessageResponse = zod
  .object({
    channel_id: zod
      .string()
      .uuid()
      .describe('Channel this message belongs to.'),
    created_at: zod
      .string()
      .datetime({})
    ...
    message_id: zod.string().uuid().describe('The requested message id.'),
    thread_id: zod
      .string()
      .uuid()
      .describe(
