...
export const postItemsSoupAstGroupedBody = zod
  ...
  .and(
    zod
      .object({
        ...
        sort_method: zod
          .union([
            zod.null(),
            zod
              .enum(['viewed_at', 'created_at', 'updated_at', 'viewed_updated'])
              .describe(
      ...
      .describe('Parameters for grouped soup queries.')
  )
...
export const postItemsSoupAstGroupedResponse = zod
  .object({
    ...
    next_cursor: zod
      .string()
      .nullish()
      .describe('Cursor to load the next page (global pagination)'),
  })
  .describe(
