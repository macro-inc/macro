...
function DocumentMentionPill(props: { notification: UnifiedNotification }) {
  ...
  return (
    ...
    >
      ...
      <Button
        class="absolute -top-1.5 -right-1.5 size-5 rounded-full bg-panel border border-edge-muted/50 p-0 place-items-center hidden group-hover:grid hover:bg-accent! hover:text-panel!"
    ...
    <div class="relative pt-1">
      ...
      >
        ...
        <Show when={overflow() > 0}>
          <button
            class="text-xs text-ink-muted border border-edge-muted/50 rounded-md px-2 py-1 bg-panel hover:bg-hover shrink-0"
            onClick={(e) => {
              e.stopPropagation();
              setExpanded(true);
            }}
