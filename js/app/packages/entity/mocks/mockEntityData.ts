...
export const MOCK_PROPERTIES: Property[] = [
  {
    ...
    options: [
      {
        ...
        created_at: new Date(MOCK_TIMESTAMPS.lastMonth),
        updated_at: new Date(MOCK_TIMESTAMPS.lastMonth),
    ...
    createdAt: new Date(MOCK_TIMESTAMPS.lastMonth),
    updatedAt: new Date(MOCK_TIMESTAMPS.today),
  },
  {
