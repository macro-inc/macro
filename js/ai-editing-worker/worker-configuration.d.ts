/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 746ed5ca7be3e5aeb3d3a245a59d3cb9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_WS_BASE">> {}
}
declare module "*.md" {
	const value: string;
