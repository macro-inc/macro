/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4bfc4f9de108d9db307dd0ddb559265)
// Runtime types generated with workerd@1.20260617.1 2025-07-22 nodejs_compat
interface __BaseEnv_Env {
	SYNC_WS_BASE: "ws://localhost:8787" | "wss://sync-service-dev3.macroverse.workers.dev" | "wss://sync-service-prod2.macroverse.workers.dev";
...
declare namespace Cloudflare {
	...
	interface LocalEnv {
		SYNC_WS_BASE: "ws://localhost:8787";
		ANTHROPIC_API_KEY: string;
		OPENAI_API_KEY: string;
		CEREBRAS_API_KEY: string;
		GOOGLE_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_WS_BASE" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "CEREBRAS_API_KEY" | "GOOGLE_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
