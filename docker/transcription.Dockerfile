...
# Keep the Hugging Face cache inside /app so downloaded plugin models
# (e.g. the turn detector) survive the build→production COPY step.
...
RUN python "transcriber.py" download-files
