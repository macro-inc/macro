...
export class Sdk extends HeyApiClient {
     ...
     * turn numbering.
     */
    public getAgentChannelLog<ThrowOnError extends boolean = false>(options: Options<GetAgentChannelLogData, ThrowOnError>): RequestResult<GetAgentChannelLogResponses, GetAgentChannelLogErrors, ThrowOnError> {
        return (options.client ?? this.client).get<GetAgentChannelLogResponses, GetAgentChannelLogErrors, ThrowOnError>({ url: '/agent-sessions/channel/{channel_id}/log', ...options });
    }
