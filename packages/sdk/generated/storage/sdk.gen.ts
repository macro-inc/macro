...
export class Sdk extends HeyApiClient {
     ...
     */
    public getChannelCategoryLayout<ThrowOnError extends boolean = false>(options?: Options<GetChannelCategoryLayoutData, ThrowOnError>): RequestResult<GetChannelCategoryLayoutResponses, unknown, ThrowOnError> {
        return (options?.client ?? this.client).get<GetChannelCategoryLayoutResponses, unknown, ThrowOnError>({ url: '/comms/channel-categories', ...options });
    }

    /**
     * Replace the authenticated user's personal channel-category layout.
     */
    public replaceChannelCategoryLayout<ThrowOnError extends boolean = false>(options: Options<ReplaceChannelCategoryLayoutData, ThrowOnError>): RequestResult<ReplaceChannelCategoryLayoutResponses, ReplaceChannelCategoryLayoutErrors, ThrowOnError> {
        return (options.client ?? this.client).put<ReplaceChannelCategoryLayoutResponses, ReplaceChannelCategoryLayoutErrors, ThrowOnError>({
