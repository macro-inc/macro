...
export class Sdk extends HeyApiClient {
     ...
     */
    public listChannelTopics<ThrowOnError extends boolean = false>(options?: Options<ListChannelTopicsData, ThrowOnError>): RequestResult<ListChannelTopicsResponses, unknown, ThrowOnError> {
        return (options?.client ?? this.client).get<ListChannelTopicsResponses, unknown, ThrowOnError>({ url: '/channel-topics', ...options });
    }
    
    /**
     * Create a topic.
     */
    public createChannelTopic<ThrowOnError extends boolean = false>(options: Options<CreateChannelTopicData, ThrowOnError>): RequestResult<CreateChannelTopicResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).post<CreateChannelTopicResponses, unknown, ThrowOnError>({
            url: '/channel-topics',
            ...options,
            headers: {
                'Content-Type': 'application/json',
     ...
     */
    public setChannelTopicOrder<ThrowOnError extends boolean = false>(options: Options<SetChannelTopicOrderData, ThrowOnError>): RequestResult<SetChannelTopicOrderResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).put<SetChannelTopicOrderResponses, unknown, ThrowOnError>({
     ...
     * Delete a topic.
     */
    public deleteChannelTopic<ThrowOnError extends boolean = false>(options: Options<DeleteChannelTopicData, ThrowOnError>): RequestResult<DeleteChannelTopicResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).delete<DeleteChannelTopicResponses, unknown, ThrowOnError>({ url: '/channel-topics/{id}', ...options });
    }
    
    /**
     * Update topic metadata.
     */
    public updateChannelTopic<ThrowOnError extends boolean = false>(options: Options<UpdateChannelTopicData, ThrowOnError>): RequestResult<UpdateChannelTopicResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).patch<UpdateChannelTopicResponses, unknown, ThrowOnError>({
     ...
     */
    public removeChannelFromTopic<ThrowOnError extends boolean = false>(options: Options<RemoveChannelFromTopicData, ThrowOnError>): RequestResult<RemoveChannelFromTopicResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).delete<RemoveChannelFromTopicResponses, unknown, ThrowOnError>({ url: '/channel-topics/{id}/channels/{channel_id}', ...options });
    }
    
    /**
     * File a channel under a topic.
     */
    public addChannelToTopic<ThrowOnError extends boolean = false>(options: Options<AddChannelToTopicData, ThrowOnError>): RequestResult<AddChannelToTopicResponses, unknown, ThrowOnError> {
        return (options.client ?? this.client).put<AddChannelToTopicResponses, unknown, ThrowOnError>({ url: '/channel-topics/{id}/channels/{channel_id}', ...options });
    }
