...
export type ProvisionRuntimeConnectionData = {
    body?: never;
    path: {
        /**
         * ID of the agent
    ...
    query?: never;
    url: '/agents/{agent_id}/runtime-connection';
};

export type ProvisionRuntimeConnectionErrors = {
    400: string;
    401: string;
    404: string;
    500: string;
...
export type ProvisionRuntimeConnectionError = ProvisionRuntimeConnectionErrors[keyof ProvisionRuntimeConnectionErrors];

export type ProvisionRuntimeConnectionResponses = {
    200: ProvisionRuntimeConnectionResponse;
};

export type ProvisionRuntimeConnectionResponse2 = ProvisionRuntimeConnectionResponses[keyof ProvisionRuntimeConnectionResponses];
