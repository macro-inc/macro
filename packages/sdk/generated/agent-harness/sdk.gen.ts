...
export class Sdk extends HeyApiClient {
     ...
     */
    public getAgentSessionChangesFile<ThrowOnError extends boolean = false>(options: Options<GetAgentSessionChangesFileData, ThrowOnError>): RequestResult<GetAgentSessionChangesFileResponses, GetAgentSessionChangesFileErrors, ThrowOnError> {
        return (options.client ?? this.client).get<GetAgentSessionChangesFileResponses, GetAgentSessionChangesFileErrors, ThrowOnError>({ url: '/agent-sessions/{session_id}/changes/file', ...options });
    }
